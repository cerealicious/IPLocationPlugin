...
const wchar_t* CIPLocationItem::GetItemName() const { return L"IP Location"; }
const wchar_t* CIPLocationItem::GetItemId() const { return L"IPLocationPlugin"; }
const wchar_t* CIPLocationItem::GetItemLableText() const { return L"IP"; }
...
bool CIPLocationItem::IsCustomDraw() const { return false; }
int CIPLocationItem::GetItemWidth() const { return 0; }
void CIPLocationItem::DrawItem(void* hDC, int x, int y, int w, int h, bool dark_mode) {}
int CIPLocationItem::OnMouseEvent(MouseEventType type, int x, int y, void* hWnd, int flag) { return 0; }
